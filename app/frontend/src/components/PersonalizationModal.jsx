                ...
                <div className="p-6">
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            {/* Logo upload */}
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Logo</h3>
                                    ...
                                    {logoType === 'file' ? (
                                            ...
                                            <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                                    ...
                                                    <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                                                        <span className="font-semibold">Clic para subir</span> o arrastrar archivo
                                                    </p>
                                        ...
                                        <div>
                                            <textarea
                                                ...
                                                placeholder="Ingresa el texto para tu logo..."
